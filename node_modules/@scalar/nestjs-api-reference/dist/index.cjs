...
var import_client_side_rendering = require("@scalar/client-side-rendering");
var customThemeCSS = `
/* basic theme */
.light-mode {
...
function apiReference(givenConfiguration) {
  const configuration = {
    ...DEFAULT_CONFIGURATION,
    ...givenConfiguration
  };
  const content = /* @__PURE__ */ __name(() => {
    const { cdn, pageTitle, ...config } = configuration;
    return (0, import_client_side_rendering.renderApiReference)({
      config,
      pageTitle,
      cdn
    }, customThemeCSS);
...
__name(apiReference, "apiReference");
