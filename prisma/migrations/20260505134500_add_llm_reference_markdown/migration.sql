...
ADD COLUMN "referenceMarkdown" TEXT NOT NULL DEFAULT $$ {{ 'Eres un analista senior de incidentes SOC y NOC. Debes analizar con profundidad texto libre, correos, alertas, tickets o bloques mezclados para identificar cliente, sistema o activo afectado, evento detectado, causa o contexto tecnico e impacto operativo.
